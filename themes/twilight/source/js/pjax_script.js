...
_$$(
  ...
  if (window.TWILIGHT_CONFIG.icon_font) {
    // iconfont
    element.innerHTML = window.TWILIGHT_CONFIG.anchor_icon
      ? `&#x${window.TWILIGHT_CONFIG.anchor_icon};`
      : window.TWILIGHT_CONFIG.anchor_icon === false ? "" : "&#xe635;";
  } else {
    // fontawesome
    element.innerHTML = window.TWILIGHT_CONFIG.anchor_icon
      ? `&#x${window.TWILIGHT_CONFIG.anchor_icon};`
